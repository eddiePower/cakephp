    ...
    public function validationDefault(Validator $validator)
    {
        $validator
           ->add('id', 'valid', ['rule' => 'numeric'])
            ...
            ->add('matt_bale_count', 'valid', ['rule' => 'numeric'])
            ->requirePresence('matt_bale_count', 'create')
            ->notEmpty('matt_bale_count')
            ->add('bale_cost', 'valid', ['rule' => 'numeric'])
            ->requirePresence('bale_cost', 'create')
            ->notEmpty('bale_cost')
            ->add('matt_weight', 'valid', ['rule' => 'numeric'])
            ->requirePresence('matt_weight', 'create')
            ->notEmpty('matt_weight')
