...
use App\Model\Entity\PurchaseDetail;
use Cake\ORM\Query;
...
class PurchaseDetailsTable extends Table
{
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->add('quantity_purchased', 'valid', ['rule' => 'numeric'])
            ->requirePresence('quantity_purchased', 'create')
            ->notEmpty('quantity_purchased');
            
        $validator
            ->add('price_of_item', 'valid', ['rule' => 'numeric'])
            ->requirePresence('price_of_item', 'create')
            ->notEmpty('price_of_item');
